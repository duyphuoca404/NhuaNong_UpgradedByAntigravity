...
namespace NhuaNong.Core
{
  public sealed class IoC
  {
    ...
    {
      IoC.Current.Container.RegisterType<I, T>((LifetimeManager) new ContainerControlledLifetimeManager());
    }

    public static void InjectStub<I>(I instance)
    {
      IoC.Current.Container.RegisterInstance<I>(instance, (LifetimeManager) new ContainerControlledLifetimeManager());
    }
