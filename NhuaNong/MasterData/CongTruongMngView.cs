...
{
  public class CongTruongMngView : ControlViewBase, ICongTruongMngView, IBase, IPermission
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.txtTenCT.Properties.BeginInit();
      this.txtMaCT.Properties.BeginInit();
      ...
      this.grcCongTruong.BeginInit();
      this.grvCongTruong.BeginInit();
      this.SuspendLayout();
      ...
      this.grcSearch.Controls.Add((Control) this.lblAddress);
      this.grcSearch.Controls.Add((Control) this.lblTenCongTruong);
      this.grcSearch.Controls.Add((Control) this.lblMaCongTruong);
      ...
      this.grcSearch.Controls.Add((Control) this.txtTenCT);
      this.grcSearch.Controls.Add((Control) this.txtMaCT);
      ...
      this.lblTenCongTruong.Appearance.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
      ...
      this.lblMaCongTruong.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
      ...
      this.txtTenCT.Properties.Appearance.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
      ...
      this.txtMaCT.Properties.Appearance.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
      ...
      this.grpMaster.Controls.Add((Control) this.grcCongTruong);
      ...
      this.grcCongTruong.MainView = (BaseView) this.grvCongTruong;
      this.grcCongTruong.Margin = new Padding(2);
      this.grcCongTruong.MenuManager = (IDXMenuManager) this.barManager1;
      this.grcCongTruong.Name = "grcCongTruong";
      this.grcCongTruong.Size = new Size(697, 529);
      this.grcCongTruong.TabIndex = 0;
      this.grcCongTruong.ViewCollection.AddRange(new BaseView[1]
      {
        (BaseView) this.grvCongTruong
      });
      this.grvCongTruong.Columns.AddRange(new GridColumn[6]
      {
        this.gcMaCongTruong,
      ...
      this.txtTenCT.Properties.EndInit();
      this.txtMaCT.Properties.EndInit();
      ...
      this.grcCongTruong.EndInit();
      this.grvCongTruong.EndInit();
