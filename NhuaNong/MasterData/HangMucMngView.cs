...
{
  public class HangMucMngView : ControlViewBase, IHangMucMngView, IBase, IPermission
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.txtTenHM.Properties.BeginInit();
      this.txtMaHM.Properties.BeginInit();
      ...
      this.grcHangMuc.BeginInit();
      this.grvHangMuc.BeginInit();
      ...
      this.lblTenHangMuc.Appearance.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
      ...
      this.lblMaHangMuc.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
      ...
      this.txtTenHM.Properties.Appearance.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
      ...
      this.txtMaHM.Properties.Appearance.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
      ...
      this.grcMaster.Controls.Add((Control) this.grcHangMuc);
      ...
      this.grcHangMuc.MainView = (BaseView) this.grvHangMuc;
      this.grcHangMuc.Margin = new Padding(2);
      this.grcHangMuc.MenuManager = (IDXMenuManager) this.barManager1;
      this.grcHangMuc.Name = "grcHangMuc";
      this.grcHangMuc.Size = new Size(753, 495);
      this.grcHangMuc.TabIndex = 0;
      this.grcHangMuc.ViewCollection.AddRange(new BaseView[1]
      {
        (BaseView) this.grvHangMuc
      });
      this.grvHangMuc.Columns.AddRange(new GridColumn[4]
      {
        this.gcMaHangMuc,
        this.gcTenHangMuc,
        this.gcGhiChu,
      ...
      this.grcSearch.Controls.Add((Control) this.lblTenHangMuc);
      this.grcSearch.Controls.Add((Control) this.lblMaHangMuc);
      ...
      this.grcSearch.Controls.Add((Control) this.txtTenHM);
      this.grcSearch.Controls.Add((Control) this.txtMaHM);
      ...
      this.Name = nameof (HangMucMngView);
      this.Size = new Size(1037, 560);
      this.lueActive.Properties.EndInit();
      this.barManager1.EndInit();
      this.txtTenHM.Properties.EndInit();
      this.txtMaHM.Properties.EndInit();
      ...
      this.grcHangMuc.EndInit();
      this.grvHangMuc.EndInit();
