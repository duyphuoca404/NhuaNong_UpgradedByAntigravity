...
{
  public class NhanVienMngView : ControlViewBase, INhanVienMngView, IBase, IPermission
  {
    ...
    private GridColumn gcTenNhanVien;
    private GridColumn gcMaNhanVien;
    private GridView grvNhanVien;
    private GridColumn gcGhiChu;
    private GridControl grcNhanVien;
    ...
    private void InitializeComponent()
    {
      ...
      this.gcTenNhanVien = new GridColumn();
      this.gcMaNhanVien = new GridColumn();
      this.grvNhanVien = new GridView();
      this.gcGhiChu = new GridColumn();
      this.grcNhanVien = new GridControl();
      ...
      this.txtTenNV.Properties.BeginInit();
      this.txtMaNV.Properties.BeginInit();
      ...
      this.grvNhanVien.Columns.AddRange(new GridColumn[5]
      {
        this.gcMaNhanVien,
        this.gcTenNhanVien,
        this.gcPhone,
      ...
      this.grcNhanVien.Dock = DockStyle.Fill;
      this.grcNhanVien.EmbeddedNavigator.Margin = new Padding(2);
      this.grcNhanVien.Location = new Point(2, 23);
      this.grcNhanVien.MainView = (BaseView) this.grvNhanVien;
      this.grcNhanVien.Margin = new Padding(2);
      this.grcNhanVien.MenuManager = (IDXMenuManager) this.barManager1;
      this.grcNhanVien.Name = "grcNhanVien";
      this.grcNhanVien.Size = new Size(856, 252);
      this.grcNhanVien.TabIndex = 0;
      this.grcNhanVien.ViewCollection.AddRange(new BaseView[1]
      {
        (BaseView) this.grvNhanVien
      });
      ...
      this.barDockControlTop.Size = new Size(860, 40);
      this.barDockControlBottom.CausesValidation = false;
      this.barDockControlBottom.Dock = DockStyle.Bottom;
      this.barDockControlBottom.Location = new Point(0, 479);
      this.barDockControlBottom.Manager = this.barManager1;
      this.barDockControlBottom.Margin = new Padding(2);
      this.barDockControlBottom.Size = new Size(860, 0);
      this.barDockControlLeft.CausesValidation = false;
      this.barDockControlLeft.Dock = DockStyle.Left;
      this.barDockControlLeft.Location = new Point(0, 40);
      this.barDockControlLeft.Manager = this.barManager1;
      this.barDockControlLeft.Margin = new Padding(2);
      this.barDockControlLeft.Size = new Size(0, 439);
      this.barDockControlRight.CausesValidation = false;
      this.barDockControlRight.Dock = DockStyle.Right;
      this.barDockControlRight.Location = new Point(860, 40);
      this.barDockControlRight.Manager = this.barManager1;
      this.barDockControlRight.Margin = new Padding(2);
      this.barDockControlRight.Size = new Size(0, 439);
      this.grcMaster.Controls.Add((Control) this.grcNhanVien);
      this.grcMaster.Dock = DockStyle.Fill;
      this.grcMaster.Location = new Point(0, 202);
      this.grcMaster.Margin = new Padding(2);
      this.grcMaster.Name = "grcMaster";
      this.grcMaster.Size = new Size(860, 277);
      this.grcMaster.TabIndex = 7;
      this.grcMaster.Text = "Dữ liệu";
      this.btnReset.Location = new Point(546, 104);
      ...
      this.lueActive.Location = new Point(174, 101);
      ...
      this.lueActive.Size = new Size(94, 20);
      this.lueActive.TabIndex = 99;
      this.lueActive.Visible = false;
      this.txtPhone.Location = new Point(369, 101);
      this.txtPhone.Margin = new Padding(2);
      this.txtPhone.Name = "txtPhone";
      this.txtPhone.Properties.Name = "txtPhone";
      this.txtPhone.Size = new Size(94, 20);
      this.txtPhone.TabIndex = 98;
      this.txtTenNV.Location = new Point(369, 73);
      this.txtTenNV.Margin = new Padding(2);
      this.txtTenNV.Name = "txtTenNV";
      this.txtTenNV.Size = new Size(94, 20);
      this.txtTenNV.TabIndex = 96;
      this.txtMaNV.Location = new Point(174, 73);
      this.txtMaNV.Margin = new Padding(2);
      this.txtMaNV.Name = "txtMaNV";
      this.txtMaNV.Size = new Size(94, 20);
      this.txtMaNV.TabIndex = 95;
      this.datToDate.EditValue = (object) null;
      this.datToDate.Location = new Point(369, 45);
      ...
      this.datToDate.Size = new Size(94, 20);
      this.datToDate.TabIndex = 94;
      this.datFromDate.EditValue = (object) null;
      this.datFromDate.Location = new Point(174, 45);
      ...
      this.datFromDate.Size = new Size(94, 20);
      ...
      this.grcSearch.Controls.Add((Control) this.txtTenNV);
      this.grcSearch.Controls.Add((Control) this.txtMaNV);
      ...
      this.grcSearch.Dock = DockStyle.Top;
      this.grcSearch.Location = new Point(0, 40);
      this.grcSearch.Margin = new Padding(2);
      this.grcSearch.Name = "grcSearch";
      this.grcSearch.Size = new Size(860, 162);
      this.grcSearch.TabIndex = 6;
      this.grcSearch.Text = "Tìm kiếm";
      this.lblFromDate.Location = new Point(89, 48);
      this.lblFromDate.Margin = new Padding(2);
      this.lblFromDate.Name = "lblFromDate";
      this.lblFromDate.Size = new Size(61, 13);
      ...
      this.grvNhanVien.EndInit();
      this.grcNhanVien.EndInit();
      ...
      this.txtTenNV.Properties.EndInit();
      this.txtMaNV.Properties.EndInit();
