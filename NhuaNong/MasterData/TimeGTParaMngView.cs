...
// Type: NhuaNong.MasterData.TimeGTParaMngView
...
{
  public partial class TimeGTParaMngView : ControlViewBase, ITimerParaMngView, IBase, IPermission
  {
    ...
    public TimeGTParaMngView()
    {
      this.InitializeComponent();
      this.Name = nameof(TimeGTParaMngView);
    ...
    public BindingList<ObjTimerPara> BLstTimerPara
    {
      set
      {
        ...
        this._listTimer.Add(value[20]);
        this._listTimer.Add(value[21]);
        this._listTimer.Add(value[22]);
        this._listTimer.Add(value[23]);
