...
// Type: NhuaNong.MasterData.TimerPCMngView
...
{
  public class TimerPCMngView : ControlViewBase, ITimerParaMngView, IBase, IPermission
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.bsiCaption.Caption = "Thời gian Phễu chờ";
      ...
      this.Name = nameof (TimerPCMngView);
