...
{
  public class TimerParaMngView : ControlViewBase, ITimerParaMngView, IBase, IPermission
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.bsiCaption.Caption = "Thông số Thời gian";
      ...
      this.bbiSaveTimer.ItemAppearance.Normal.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
      this.bbiSaveTimer.ItemAppearance.Normal.Options.UseFont = true;
      ...
      this.bbiRefreshTimer.ItemAppearance.Normal.Font = new Font("Tahoma", 9.75f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
      this.bbiRefreshTimer.ItemAppearance.Normal.Options.UseFont = true;
      ...
      this.gcDesc.Caption = "Thông số thời gian";
