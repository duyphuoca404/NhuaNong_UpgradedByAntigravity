...
// Type: NhuaNong.MasterData.UcLogicSiloCe
...
{
  public class UcLogicSiloCe : UcLogicBase
  {
    private IContainer components;

    public UcLogicSiloCe() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = nameof (UcLogicSiloCe);
      this.NhomSilo = UcLogicBase.NhomSiloEnum.CE;
