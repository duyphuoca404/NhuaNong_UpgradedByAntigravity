...
namespace NhuaNong
{
  public partial class SettingProduct : DialogViewBase
  {
    ...
    //private void lblSecretTrigger_Click(object sender, EventArgs e)
    //{
    //  // Đảo ngược giá trị của công tắc
    //  ConfigManager.TramTronConfig.NgayTron_Stus = !ConfigManager.TramTronConfig.NgayTron_Stus;

    //  // Cập nhật giao diện để bạn biết nó đã hoạt động
    //  this.lblCheck.Visible = ConfigManager.TramTronConfig.NgayTron_Stus;

    //  // Hiển thị một thông báo xác nhận
    //  string status = ConfigManager.TramTronConfig.NgayTron_Stus ? "BẬT" : "TẮT";
    //  MessageBox.Show("Công tắc ẩn đã được " + status, "Thông Báo Bí Mật", MessageBoxButtons.OK, MessageBoxIcon.Information);
    //}
