...
// Type: NhuaNong.UserControls.ucBtnFU
...
{
  public class ucBtnFU : UserControl
  {
    ...
    public event ucBtnFU.ButtonEventHandler ButtonClick;

    public event ucBtnFU.ButtonEventHandler ButtonMouseDown;

    public event ucBtnFU.ButtonEventHandler ButtonMouseUp;
    ...
    public ucBtnFU() => this.InitializeComponent();

    private void ucBtnFU_Click(object sender, EventArgs e)
    {
    ...
    private void ucBtnFU_MouseDown(object sender, MouseEventArgs e)
    {
    ...
    private void ucBtnFU_MouseUp(object sender, MouseEventArgs e)
    {
