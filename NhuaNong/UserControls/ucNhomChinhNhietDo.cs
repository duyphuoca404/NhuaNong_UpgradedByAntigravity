...
// Type: NhuaNong.UserControls.ucNhomChinhNhietDo
...
{
  public class ucNhomChinhNhietDo : UserControl
  {
    ...
    public ucNhomChinhNhietDo() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      this.btnChinhTai.Appearance.BackColor = Color.Red;
      ...
      this.lblKLThucTe.Size = new Size(90, 19);
      this.lblKLThucTe.TabIndex = 9;
      this.lblKLThucTe.Text = "ND Thực tế";
      ...
      this.lblNhap0.Size = new Size(93, 19);
      this.lblNhap0.TabIndex = 4;
      this.lblNhap0.Text = "Nhiệt độ T1";
      ...
      this.lblNhapTai.Size = new Size(93, 19);
      this.lblNhapTai.TabIndex = 2;
      this.lblNhapTai.Text = "Nhiệt độ T2";
