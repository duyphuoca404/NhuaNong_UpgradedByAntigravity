...
// Type: NhuaNong.UserControls.ucSiloAGG
...
{
  public class ucSiloAGG : ucBaseSilo
  {
    private IContainer components;

    public ucSiloAGG() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      this.picBackground.EditValue = (object) ResourceNhua._silo_AGG;
