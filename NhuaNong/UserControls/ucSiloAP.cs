...
// Type: NhuaNong.UserControls.ucSiloAP
...
{
  public class ucSiloAP : ucBaseSilo
  {
    private IContainer components;

    public ucSiloAP() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      this.picBackground.EditValue = (object) ResourceNhua._silo_AP;
