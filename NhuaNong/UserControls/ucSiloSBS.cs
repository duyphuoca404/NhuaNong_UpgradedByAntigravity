...
// Type: NhuaNong.UserControls.ucSiloSBS
...
{
  public class ucSiloSBS : ucBaseSilo
  {
    private IContainer components;

    public ucSiloSBS() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      this.picBackground.EditValue = (object) ResourceNhua._silo_SBS;
      ...
      this.spn1.Properties.Appearance.Options.UseTextOptions = true;
      this.spn1.Properties.Appearance.TextOptions.HAlignment = HorzAlignment.Center;
      this.spn1.Properties.DisplayFormat.FormatString = "n2";
      ...
      this.spn1.Properties.MaskSettings.Set("mask", (object) "n2");
      ...
      this.spn2.Properties.Appearance.Options.UseTextOptions = true;
      this.spn2.Properties.Appearance.TextOptions.HAlignment = HorzAlignment.Center;
      this.spn2.Properties.DisplayFormat.FormatString = "n2";
      ...
      this.spn2.Properties.MaskSettings.Set("mask", (object) "n2");
      ...
      this.spn3.Properties.Appearance.Options.UseTextOptions = true;
      this.spn3.Properties.Appearance.TextOptions.HAlignment = HorzAlignment.Center;
      this.spn3.Properties.DisplayFormat.FormatString = "n2";
