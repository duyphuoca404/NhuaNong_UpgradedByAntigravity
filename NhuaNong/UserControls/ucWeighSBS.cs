...
// Type: NhuaNong.UserControls.ucWeighSBS
...
{
  public class ucWeighSBS : ucBaseWeight
  {
    private IContainer components;

    public ucWeighSBS() => this.InitializeComponent();
    ...
    private void InitializeComponent()
    {
      ...
      this.SuspendLayout();
      this.picWeigh.BackgroundImage = (Image) ResourceNhua._can_SBS;
      ...
      this.spinEdit1.Properties.MaskSettings.Set("mask", (object) "n2");
      this.spinEdit1.Size = new Size(74, 34);
      this.AutoScaleDimensions = new SizeF(6f, 13f);
      this.AutoScaleMode = AutoScaleMode.Font;
      this.Name = nameof (ucWeighSBS);
